...
This three-day course offers a practical, hands-on journey into the world of Python programming. We'll cover the essential language features and build your skills progressively. Labs use compact, data-flavoured scenarios—playlist queues, bill tips, ticket codes, and event CSVs—so each exercise feels concrete while the teaching steps stay familiar. By the end, you'll have the confidence to apply Python to practical data-handling tasks and to continue into larger projects or specialisations.
